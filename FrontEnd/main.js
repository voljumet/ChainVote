...
async function login() {
  try {
    ...
    document.getElementById("getCasesWaitingForApproval").style.display =
      "block";
...
document.getElementById("deactivate_case").onclick = function () {
  deactivateCase(document.getElementById("caseNumber2").value);
};
